...
export function parseArgs(argv) {
  ...
  if (rest.includes('--help') || rest.includes('-h')) {
    return { subcommand: 'help', subcommandArgs: [], workspace: process.cwd(), extraDirs: [], claudeArgs: [], sessionName: null };
  }
  ...
  return { subcommand, subcommandArgs: [], workspace, extraDirs, claudeArgs, runtimeArg, mcpRw, sessionName };
}
